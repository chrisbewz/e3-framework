...
{
    public static async Task<IEnumerable<IAttributeBase>> ConfigureAttributes(this IComponentBase<INetSegmentInterface> component, IAttributeInterface instance)
    {
        var id = component.Id;
