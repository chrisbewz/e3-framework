...
{
    public static async Task<IEnumerable<IAttributeBase>> ConfigureAttributes(this IComponentBase<IConnectionInterface> component, IAttributeInterface instance)
    {
        var id = component.Id;
